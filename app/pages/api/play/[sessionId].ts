...
import { SessionGetResponse, SessionPutRequest, SessionPutResponse } from '../../../utils/types';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    if (req.method === 'GET') {
        ...
        const errorMessage = isValidMove(body.board, session.board, evaluate(game.answer));
        if (errorMessage) {
