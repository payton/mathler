    ...
    <>
        ...
        <div className="h-screen w-screen flex flex-col" style={{backgroundColor: "#018080"}}>
            <div className="w-full h-full" id="desktop">
                <div className="login-screen window select-none absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style={{width: "400px"}}>
                    ...
                    <div className="window-body">
                        <div className="grid grid-cols-6 grid-rows-2 gap-4 justify-items-center">
                            <div className="col-span-6 row-span-1 align-center">
                                <img src="/w9e.png" alt="Notepad icon" className="w-auto h-20 mr-1" />
                            </div>
                            <div className="col-span-6 row-span-1 w-full">
                                <p className="mb-1">Select a <u>w</u>allet:</p>
                                <select id="selectProvider" className="w-full pl-1">
                                    <option value="dynamic" selected>Dynamic</option>
                                </select>
                                <p className="mb-1 mt-3">Password:</p>
                                <input className="w-full" type="text" disabled value="No passwords here!" />
                            </div>
                            <div className="col-span-6 row-span-1 w-full items-end">
                                <button className='px-4' onClick={() => setShowAuthFlow(true)}>Sign-In with Ethereum</button>
                            </div>
                        </div>
                    </div>
                </div>
